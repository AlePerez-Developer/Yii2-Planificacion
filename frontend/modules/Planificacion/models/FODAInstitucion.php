...
/**
 * This is the model class for table "FODAInstitucion".
 *
 ...
 */
class FODAInstitucion extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['IdGestion', 'Descripcion', 'Tipo', 'Incidencia', 'CodigoEstado', 'CodigoUsuario'], 'required'],
            [['IdFoda', 'IdGestion'], 'string', 'max' => 36],
