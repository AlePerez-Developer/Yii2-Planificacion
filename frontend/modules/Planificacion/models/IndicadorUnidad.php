...
/**
 * This is the model class for table "IndicadoresUnidades".
 *
 ...
 */
class IndicadorUnidad extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Indicador::className(), ['Unidad' => 'CodigoTipo']);
    }
}
