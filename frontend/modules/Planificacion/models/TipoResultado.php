...
/**
 * This is the model class for table "TiposResultados".
 *
 ...
 */
class TipoResultado extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Indicador::className(), ['Resultado' => 'CodigoTipo']);
    }
}
