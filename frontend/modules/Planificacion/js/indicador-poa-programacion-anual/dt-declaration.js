...
function inicializarTablaIndicadoresPoaProgramacion() {
    dt_programacionPoaAnual = PlanificacionDataTable.crear('#tablaListaIndicadoresPoaProgramacion', {
        planificacion: {loader: true},
        ajax: PlanificacionDataTable.ajax({
            url: 'index.php?r=Planificacion/indicador-poa-programacion-anual/listar-indicadores',
            data: function (d) {
                d.idObjEspecifico = programacionPoaAnual_s2ObjEspecifico.val() || '00000000-0000-0000-0000-000000000000';
            }
        }),
        columns: [
            {
