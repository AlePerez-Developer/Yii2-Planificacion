            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return ( (type === 'display') && (row.CodigoEstado === ESTADO_VIGENTE))
                        ? '<button type="button" class="btn btn-success btn-sm btnEstado" codigo="' + row.CodigoPrograma + '" estado =  "' + ESTADO_VIGENTE + '" ></button>'
                        : '<button type="button" class="btn btn-danger btn-sm  btnEstado" codigo="' + row.CodigoPrograma + '" estado =  "' + ESTADO_CADUCO + '" ></button>' ;
                },
            },
            {
