...
$this->registerJsFile("@web/js/programa/Programa.js", [
    'depends' => [
...
<div class="card ">
        ...
        <div class="col d-flex justify-content-center">
            <div class="card " style="width: 50rem;">
                ...
                <div class="card-body">
                    ...
                    <form id="formProgramas" action="" method="post">
    ...
    <div id="divTabla" name="divTabla" class="card-body">
        <table id="tablaListaProgramas" name="tablaListaActividades" class="table table-bordered table-striped dt-responsive"
               style="width: 100%">
            <thead>
