...
$this->registerJsFile('@planificacionModule/js/items-catalogados/s2-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/items-catalogados/dt-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/items-catalogados/index.js', ['depends' => [JqueryAsset::class]]);

$this->title = 'Planificación Institucional';
$this->params['subtitle'] = "Formulario {$formulario} - Ítems catalogados";
$this->params['icon'] = 'fas fa-boxes';
...
<div id="itemsCatalogadosPage" data-formulario="<?= (int)$formulario ?>"
     data-reporte="<?= Url::to(['items-catalogados/reporte', 'formulario' => $formulario]) ?>">
    <div class="card">
        <div id="divDatos" class="card-body" style="display:none">
            <div class="col d-flex justify-content-center">
                <div class="card-dtic-form" style="width: 120rem;">
                    <div class="card-header card-dtic-form-header">Ingreso de ítem catalogado</div>
                    <div class="card-body card-dtic-form-body">
                        <form id="formItemCatalogado" autocomplete="off">
                            <input type="hidden" id="idItem" name="idItem">
                            <input type="hidden" id="idSigma" name="idSigma">

                            <div class="mb-3">
                                <button id="btnSeleccionarSigma" type="button" class="btn btn-outline-primary">
                                    <i class="fas fa-search"></i> Seleccionar ítem SIGMA
                                </button>
                            </div>

                            <div id="detalleSigma" class="sigma-preview mb-3" style="display:none"></div>
        ...
        <div id="divTabla" class="card-body">
            <div class="card-dtic-style">
                ...
                <div id="dticTableContainer" class="p-2" style="display:none">
                    <table id="tablaListaItemsCatalogados" class="table w-100 dtic-table"></table>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="modalSigma" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Seleccionar ítem SIGMA</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="tablaSigma" class="table w-100 dtic-table">
                        <thead>
                        <tr>
                            <th>Clase</th>
                            <th>Descripción</th>
