        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title">Ítems catalogados</h5>
                ...
                <div class="modal-body">
                    <form id="formItemCatalogado" autocomplete="off">
                        <input type="hidden" id="idItemCatalogado">
                        <div class="form-group">
                            <label for="idSigma">Ítem del catálogo SIGMA</label>
                            <select id="idSigma" class="form-control" style="width:100%"></select>
                        </div>
