...
$this->registerJsFile('@planificacionModule/js/foda-unidad/dt-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/foda-unidad/index.js', ['depends' => [JqueryAsset::class]]);
...
<div class="card">
    <div id="divDatos" class="card-body" style="display:none">
        <form id="formFodaUnidad" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="tipo" name="tipo" class="form-control dtic-input">
                                    ...
                                    <?php foreach (FODAUnidad::tipos() as $tipo): ?>
    ...
    <div id="divTabla" class="card-body">
        <div class="card-dtic-style">
            ...
            <div id="dticTableContainer" class="p-2" style="display:none">
                <table id="tablaFodaUnidad" class="table w-100 dtic-table"></table>
            </div>
        </div>
    </div>
</div>
