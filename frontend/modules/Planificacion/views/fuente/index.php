...
$this->registerJsFile('@planificacionModule/js/fuente/dt-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/fuente/index.js', ['depends' => [JqueryAsset::class]]);

$this->title = 'Planificación Institucional';
$this->params['subtitle'] = 'Administración de fuentes';
...
$this->params['breadcrumbs'][] = ['label' => '/ Fuentes'];
?>
    ...
    <div id="divTabla" class="card-body">
        <div class="card-dtic-style">
            <div class="card-dtic-style-header">
                <div class="card-dtic-style-title">Fuentes</div>
            </div>
            ...
            <div id="dticTableContainer" class="p-2" style="display:none">
                <table id="tablaListaFuentes" class="table w-100 dtic-table"></table>
            </div>
        </div>
    </div>
</div>
