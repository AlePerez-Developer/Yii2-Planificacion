...
$this->registerJsFile('@planificacionModule/js/partida/s2-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/partida/dt-declaration.js', ['depends' => [JqueryAsset::class]]);
$this->registerJsFile('@planificacionModule/js/partida/index.js', ['depends' => [JqueryAsset::class]]);

$this->title = 'Planificación Institucional';
$this->params['subtitle'] = 'Administración de partidas';
$this->params['icon'] = 'fas fa-layer-group';
...
$this->params['breadcrumbs'][] = ['label' => '/ Partidas'];
?>
        ...
        <div class="col d-flex justify-content-center">
            <div class="card-dtic-form" style="width: 120rem;">
                ...
                <div class="card-body card-dtic-form-body">
                    <form id="formPartida" autocomplete="off">
    ...
    <div id="divTabla" class="card-body">
        <div class="card-dtic-style">
            <div class="card-dtic-style-header">
                <div class="card-dtic-style-title">Partidas</div>
            </div>
            ...
            <div id="dticTableContainer" class="p-2" style="display:none">
                <table id="tablaListaPartidas" class="table w-100 dtic-table"></table>
            </div>
        </div>
    </div>
</div>
