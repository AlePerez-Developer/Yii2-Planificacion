...
$this->registerJsFile("@planificacionModule/js/Proyecto/dt-declaration.js", [
    'depends' => [
        JqueryAsset::class
    ]
]);

$this->registerJsFile("@planificacionModule/js/Proyecto/s2-declaration.js", [
    'depends' => [
        JqueryAsset::class
    ]
]);
...
<div class="card ">
    ...
    <div id="divDatos" class="card-body" style="display: none">
        <div class="col d-flex justify-content-center">
            <div class="card " style="width: 60rem;">
                ...
                <div class="card-body">
                    <form id="formProyecto" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="codigo" class="control-label">Codigo de proyecto</label>
                            <input type="text" id="codigo" name="codigo" class="form-control codigo_group num"   placeholder="Codigo" style="width: 360px">
                        </div>
    ...
    <div id="divTabla" class="card-body">
        <table id="tablaListaProyectos" name="tablaListaActividades" class="table table-bordered table-striped">
            <thead>
            <th>#</th>
            <th>Programa</th>
            <th>Codigo</th>
