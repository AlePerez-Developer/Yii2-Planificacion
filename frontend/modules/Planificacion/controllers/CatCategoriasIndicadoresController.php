 ...
 */
class CatCategoriasIndicadoresController extends BaseController
{
    private CatCategoriaIndicadorService $service;

    public function __construct($id, $module, CatCategoriaIndicadorService $service, $config = [])
    {
