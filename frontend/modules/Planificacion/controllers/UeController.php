...
use app\modules\Planificacion\services\UeService;
...
class UeController extends BaseController
{
    ...
    public function __construct($id, $module, UeService $service, $config = [])
    {
    ...
    {
        if ($action->id == 'listar-todo' || $action->id == 'listar-ues') {
    ...
    public function actionListarUesS2(): array
    {
        ...
        return $this->withTryCatch(fn() => $this->service->listarUesS2($search)) ;
    }
