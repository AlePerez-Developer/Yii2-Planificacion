 ...
 */
class CatTiposResultadosController extends BaseController
{
    private CatTipoResultadoService $service;

    public function __construct($id, $module, CatTipoResultadoService $service, $config = [])
    {
