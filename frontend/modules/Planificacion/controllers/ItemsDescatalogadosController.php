...
use app\modules\Planificacion\services\ItemsDescatalogadosService;
...
class ItemsDescatalogadosController extends BaseController
{
    ...
    public function __construct(
        $id,
        $module,
        private ItemsDescatalogadosService $service,
        $config = []
    ) {
    ...
    {
        $this->obtenerContexto();
        return $this->withTryCatch(fn() => $this->service->listarGastos($this->postFormulario()));
    }
    ...
    public function actionReporte(): void
    {
        ...
        $mpdf->Output("Formulario-{$formulario}-items-descatalogados.pdf", 'I');
    }
